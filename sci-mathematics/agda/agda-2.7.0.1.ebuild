...
CABAL_PN="Agda"
CABAL_PV="2.7.0.1" # the version of Agda as it appears on Hackage
...
RDEPEND=">=dev-haskell/aeson-1.1.2.0:=[profile?] <dev-haskell/aeson-2.3:=[profile?]
	...
	>=dev-haskell/pqueue-1.4.1.2:=[profile?] <dev-haskell/pqueue-1.6:=[profile?]
...
src_prepare() {
	...
	#fi
	use emacs || eapply "${FILESDIR}/${PN}-2.7.0.1-remove-emacs.patch"
}
